...
import { type TurnkeySDKClientConfig, type TurnkeySDKBrowserConfig, type IframeClientParams, type TurnkeyWalletClientConfig, AuthClient } from "./__types__/base";
...
export declare class TurnkeyBrowserSDK {
     ...
     */
    passkeyClient: (rpId?: string, timeout?: number, userVerification?: UserVerificationRequirement, allowCredentials?: PublicKeyCredentialDescriptor[]) => TurnkeyPasskeyClient;
